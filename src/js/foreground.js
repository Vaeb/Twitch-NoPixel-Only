...
const filterStreams = async () => {
    ...
    const addFactionStreams = () => {
        ...
        const baseHtml = '<div data-target="" style="order: _ORDER_;"><div class="sc-AxiKw cvBA-db"><div><div class="sc-AxiKw bOTXee"><article data-a-target="card-2" data-a-id="card-_CHANNEL1_" class="sc-AxiKw kemFRg"><div class="sc-AxiKw khuUmB"><div class="sc-AxiKw WAkfo"><div class="sc-psQdR iYtUny"><div class="sc-qPlga bDWFjp"><div class="sc-AxiKw opnxM"><a lines="1" data-a-target="preview-card-title-link" class="sc-fznMAR kIMkAW bccfYP sc-AxheI tw-link" href="/_CHANNEL1_"><div class="sc-AxiKw cbBcrH"><h3 title="_CHANNEL2_ | !Twitter | Chang Gang | NoPixel" class="sc-AxgMl fYNKqy">_CHANNEL2_ | !Twitter | Chang Gang | NoPixel</h3></div></a></div></div><div class="sc-qPlga bDWFjp"><p class="sc-AxgMl lnMkPh"><a data-test-selector="ChannelLink" data-a-target="preview-card-channel-link" class="sc-fznMAR kIMkAW tw-link" href="/_CHANNEL1_/videos">_CHANNEL2_</a></p></div><div class="sc-AxiKw blcKDu"><div class="sc-AxiKw bAQSiR"><div class="fmtiDS sc-AxheI"><div class="jRhelU sc-AxheI"><button class="sc-pJurq uZlON tw-tag" aria-label="English" data-a-target="English"><div class="sc-pRTZB bKnJeX">English</div></button></div><div class="ElNOH sc-AxheI"><button class="sc-pJurq uZlON tw-tag" aria-label="Hype Train" data-a-target="Hype Train"><div class="sc-pRTZB bKnJeX">Hype Train</div></button></div></div></div></div></div><div class="sc-pkUbs hVdjMI"><a data-a-target="card-2" data-a-id="card-_CHANNEL1_" data-test-selector="preview-card-avatar" class="sc-fznMAR iOxnOz tw-link" href="/_CHANNEL1_/videos"><div class="sc-fzokOt cIBfGk tw-aspect"><div class="sc-fznZeY iVCDsi"></div><figure aria-label="_CHANNEL1_" class="sc-fznLPX iqhQfc tw-avatar"><img class="fHxgPw sc-AxheI tw-image tw-image-avatar" alt="_CHANNEL1_" src="_PFP_"></figure></div></a></div></div></div><div class="sc-AxiKw fgvMWD"><div class="sc-fznBMq bAeMTI tw-hover-accent-effect"><div class="sc-fznNvL sc-fzocqA cDoHOc"></div><div class="sc-fznNvL sc-fzonZV jLqJFt"></div><div class="sc-fznNvL sc-fzqyOu cFAFjL"></div><div class="sc-fznNvL sc-fzqKxP lkPVDu"></div><div class="sc-fznNvL hwgDaf"><a data-a-target="preview-card-image-link" class="sc-fznMAR iOxnOz tw-link" href="/_CHANNEL1_"><div class="sc-AxiKw cvJeIz"><div class="sc-AxiKw fLrnFZ"><div class="sc-fzokOt cTfPfB tw-aspect"><div class="sc-fznZeY jDgFnh"></div><img alt="_CHANNEL2_ | !Twitter | Chang Gang | NoPixel - _CHANNEL1_" class="tw-image" src="https://static-cdn.jtvnw.net/previews-ttv/live_user__CHANNEL1_-440x248.jpg"></div><div class="sc-pANHa iGPRRc tw-media-card-image__corners"><div class="sc-AxiKw gtntkx"><div class="sc-fzokvW bJRuEw tw-channel-status-text-indicator" font-size="font-size-6"><p class="sc-AxgMl glKnlY">LIVE</p></div></div><div class="sc-AxiKw jkNSIJ"><div class="sc-fzqLLg gtdMlU tw-media-card-stat"><p class="sc-AxgMl fFPQpl">_VIEWERS_ viewers</p></div></div></div></div></div></a></div></div></div></article></div></div></div></div>';
