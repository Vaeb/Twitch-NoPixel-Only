...
const filterStreams = async () => {
    ...
    const addFactionStreams = () => {
        ...
        const baseHtml = '<div data-target="" style="order: _ORDER_;"><div class="sc-AxjAm kxIWao"><div><div class="sc-AxjAm StDqN"><article data-a-target="card-13" data-a-id="card-_CHANNEL1_" class="sc-AxjAm dBWNsP"><div class="sc-AxjAm czqVsG"><div class="sc-AxjAm btYFcj"><div class="ScTextWrapper-sc-14f6evl-1 gboCPP"><div class="ScTextMargin-sc-14f6evl-2 gzxTSt"><div class="sc-AxjAm kJwHLD"><a lines="1" data-a-target="preview-card-title-link" class="ScCoreLink-udwpw5-0 cxXSPs InjectLayout-sc-588ddc-0 gDeqEh tw-link" href="/_CHANNEL1_"><div class="sc-AxjAm faFgjY"><h3 title="_TITLE_" class="sc-AxirZ dqHsmV">_TITLE_</h3></div></a></div></div><div class="ScTextMargin-sc-14f6evl-2 gzxTSt"><p class="sc-AxirZ bsqfBW"><a data-test-selector="ChannelLink" data-a-target="preview-card-channel-link" class="ScCoreLink-udwpw5-0 cxXSPs tw-link" href="/_CHANNEL1_/videos">_CHANNEL2_</a></p></div><div class="sc-AxjAm cKgtIZ"><div class="sc-AxjAm ipUaGy"><div class="InjectLayout-sc-588ddc-0 iqJfNY"><div class="InjectLayout-sc-588ddc-0 dDlfVZ"><button class="ScTag-xzp4i-0 evwLTh tw-tag" aria-label="English" data-a-target="English"><div class="ScTagContent-xzp4i-1 jAVAzd">English</div></button></div></div></div></div></div><div class="ScImageWrapper-sc-14f6evl-0 feabhV"><a data-a-target="card-13" data-a-id="card-_CHANNEL1_" data-test-selector="preview-card-avatar" class="ScCoreLink-udwpw5-0 FXIKh tw-link" href="/_CHANNEL1_/videos"><div class="ScAspectRatio-sc-1sw3lwy-1 jHRTdb tw-aspect"><div class="ScAspectSpacer-sc-1sw3lwy-0 gkBhyN"></div><figure aria-label="_CHANNEL1_" class="ScAvatar-sc-12nlgut-0 iULHNk tw-avatar"><img class="InjectLayout-sc-588ddc-0 iyfkau tw-image tw-image-avatar" alt="_CHANNEL1_" src="_PFP_"></figure></div></a></div></div></div><div class="sc-AxjAm kJBVIw"><div class="ScWrapper-uo2e2v-0 deOKkb tw-hover-accent-effect"><div class="ScTransformWrapper-uo2e2v-1 ScCornerTop-uo2e2v-2 druxMB"></div><div class="ScTransformWrapper-uo2e2v-1 ScCornerBottom-uo2e2v-3 ipqJcY"></div><div class="ScTransformWrapper-uo2e2v-1 ScEdgeLeft-uo2e2v-4 ldnizW"></div><div class="ScTransformWrapper-uo2e2v-1 ScEdgeBottom-uo2e2v-5 iyfrlK"></div><div class="ScTransformWrapper-uo2e2v-1 eiQqOY"><a data-a-target="preview-card-image-link" class="ScCoreLink-udwpw5-0 FXIKh tw-link" href="/_CHANNEL1_"><div class="sc-AxjAm jpEGpg"><div class="sc-AxjAm hBZJQK"><div class="ScAspectRatio-sc-1sw3lwy-1 dNNaBC tw-aspect"><div class="ScAspectSpacer-sc-1sw3lwy-0 hhnnBG"></div><img alt="_TITLE_ - _CHANNEL1_" class="tw-image" src="https://static-cdn.jtvnw.net/previews-ttv/live_user__CHANNEL1_-440x248.jpg"></div><div class="ScPositionOver-sc-1iiybo2-0 hahEKi tw-media-card-image__corners"><div class="sc-AxjAm eFyVLi"><div class="ScChannelStatusTextIndicator-sc-1f5ghgf-0 YoxeW tw-channel-status-text-indicator" font-size="font-size-6"><p class="sc-AxirZ gOlXkb">LIVE</p></div></div><div class="sc-AxjAm iVDSNS"><div class="ScMediaCardStatWrapper-sc-1ncw7wk-0 fdmpWH tw-media-card-stat"><p class="sc-AxirZ ktnnZK">_VIEWERS_ viewers</p></div></div></div></div></div></a></div></div></div></article></div></div></div></div>';
